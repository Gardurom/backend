...
Route::middleware('auth:sanctum')
    ...
    ->group(function (): void {
        ...
        Route::get(
            '/{student}/positions',
            [StudentPositionController::class, 'index']
        )->middleware([
            'campus',
            'permission:geodata.view',
        ]);
...
Route::middleware([
    ...
    ->group(function (): void {
        Route::get(
            '/',
            [LocalityController::class, 'index']
        )->middleware('permission:geodata.view');

        Route::post(
            '/',
            [LocalityController::class, 'store']
        )->middleware('permission:geodata.update');

        Route::get(
            '/{locality}',
            [LocalityController::class, 'show']
        )->middleware('permission:geodata.view');

        Route::put(
            '/{locality}',
            [LocalityController::class, 'update']
        )->middleware('permission:geodata.update');
...
Route::middleware([
    ...
    ->group(function (): void {
        ...
        Route::get(
            '/{geofence}/students',
            [GeofenceStudentAssignmentController::class, 'index']
        )->middleware('permission:geofences.view');

        Route::post(
            '/{geofence}/students',
            [GeofenceStudentAssignmentController::class, 'store']
        )->middleware('permission:geofences.manage');

        Route::patch(
            '/{geofence}/students/{student}',
            [GeofenceStudentAssignmentController::class, 'update']
        )->middleware('permission:geofences.manage');

        Route::delete(
            '/{geofence}/students/{student}',
            [GeofenceStudentAssignmentController::class, 'destroy']
        )->middleware('permission:geofences.manage');

        Route::get(
            '/{geofence}/states',
            [GeofenceStudentStateController::class, 'index']
        )->middleware('permission:geofences.monitor');
...
Route::middleware([
    ...
    ->group(function (): void {
        Route::get(
            '/',
            [GeofenceEventController::class, 'index']
        )->middleware('permission:geofences.monitor');
    });